...
namespace Vu_Victoria_HW4
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            String connectionString = "Server=tcp:sp22vuvictoriahw4.database.windows.net,1433;Initial Catalog=sp22vuvictoriahw4;Persist Security Info=False;User ID=sp22vuvictoriahw4;Password=Victoria777;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
